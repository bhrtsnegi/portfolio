...
const Contact = ({ isDarkMode }) => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "5f23e6b7-ae5a-4e7c-88c6-c906f783a46e");
  ...
  return (
    <div id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
        ...
        <form className='max-w-2xl mx-auto' onSubmit={onSubmit}>
            ...
            <button type='submit' className='py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500 dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover/50'>
